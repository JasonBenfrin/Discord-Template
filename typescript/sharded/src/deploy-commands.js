...
import { Routes, REST, Collection, ApplicationCommandType } from "discord.js";
export default function deployCommands(commands, id) {
    const publicCommands = [];
    const privateCommands = new Collection();
    ...
    rest.put(Routes.applicationCommands(id), {
        body: publicCommands
    })
